...
class Blade:
    ...
    def compute_thrust_moment(self, number_sections, angle_propeller_rotation, omega, propeller_speed, cla_coeffs, cda_coeffs):
        """
        FUnction that computes the thrust of the complete blade
