...
n_blade_segment_lst = list(np.arange(50, 600, 50))               # [-] number of sections in which a single blade is divided
number_samples_lst = list(np.arange(1000, 60000, 1000))                 # [-] number of data points for the model identification
...
switch_recycle_samples = True  # Whether previous samples should be used
